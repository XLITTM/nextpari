...
export function mapPlayerGameRpcError(error: { message?: string; code?: string }): StaffOnboardingError {
  ...
  if (
    ...
    || code === 'SPORTS_STAKE_BELOW_CURRENCY_MIN'
    || code === 'SPORTS_STAKE_ABOVE_CURRENCY_MAX'
    || code === 'SPORTS_PAYOUT_ABOVE_CURRENCY_MAX'
  ...
  if (
    ...
    || code === 'CURRENCY_AMOUNT_SCALE_INVALID'
    || code === 'CASH_WITHDRAWAL_BELOW_MIN'
    || code === 'WITHDRAWAL_BELOW_CURRENCY_MIN'
    || code === 'DEPOSIT_BELOW_CURRENCY_MIN'
    || code === 'WITHDRAWAL_METHOD_INVALID'
    || code === 'CASH_PICKUP_REQUIRED'
    || code === 'DESTINATION_REQUIRED'
    || code === 'DESTINATION_TOO_LONG'
    || code === 'METHOD_LABEL_REQUIRED'
    || code === 'METHOD_LABEL_TOO_LONG'
