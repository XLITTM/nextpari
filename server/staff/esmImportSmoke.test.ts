...
const RUNTIME_GRAPH = [
  ...
  'api/player/betconstruct/sportsbook-launch.ts',
  'api/player/betconstruct/casino-launch.ts',
  'api/betconstruct/operator/[method].ts',
  'api/betconstruct/wallet/[method].ts',
